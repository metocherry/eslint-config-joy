const { rules: best } = require('../airbnb-base/rules/best-practices')
const { rules: errors } = require('../airbnb-base/rules/errors')
const { rules: es6 } = require('../airbnb-base/rules/es6')
const { rules: imports } = require('../airbnb-base/rules/imports')
const { rules: style } = require('../airbnb-base/rules/style')
const { rules: variables } = require('../airbnb-base/rules/variables')
...
module.exports = {
  ...
  rules: {
    ...
    'dot-notation': 'off',
    '@typescript-eslint/dot-notation': best['dot-notation'],
    ...
    '@typescript-eslint/no-empty-function': best['no-empty-function'],
    ...
    'no-implied-eval': 'off',
    'no-new-func': 'off',
    '@typescript-eslint/no-implied-eval': best['no-implied-eval'],

    // Replace Airbnb 'no-loop-func' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/no-loop-func.md
    'no-loop-func': 'off',
    '@typescript-eslint/no-loop-func': best['no-loop-func'],

    // Replace Airbnb 'no-magic-numbers' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/no-magic-numbers.md
    'no-magic-numbers': 'off',
    '@typescript-eslint/no-magic-numbers': best['no-magic-numbers'],

    // Replace Airbnb 'no-redeclare' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/no-redeclare.md
    'no-redeclare': 'off',
    '@typescript-eslint/no-redeclare': best['no-redeclare'],
    ...
    '@typescript-eslint/no-throw-literal': best['no-throw-literal'],

    // Replace Airbnb 'no-unused-expressions' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/no-unused-expressions.md
    'no-unused-expressions': 'off',
    '@typescript-eslint/no-unused-expressions': best['no-unused-expressions'],
    ...
    'require-await': 'off',
    '@typescript-eslint/require-await': best['require-await'],

    // Replace Airbnb 'no-return-await' rule with '@typescript-eslint' version
    // https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/return-await.md
    'no-return-await': 'off',
    '@typescript-eslint/return-await': best['no-return-await'],
